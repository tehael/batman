  ...
  Batman.RestStorage = (function(_super) {
    ...
    RestStorage.ModelMixin = Batman.extend({}, RestStorage.BaseMixin, {
      urlNestsUnder: function() {
        var deep_key, key, keys, parents, _i, _j, _len, _len1;
        ...
        return this.prototype.url = function() {
          var childSegment, deep_plural, id, parentID, plural, url;
          ...
          for (key in parents) {
            ...
            if ('Object' === Batman.typeOf(plural)) {
              for (deep_key in plural) {
                deep_plural = plural[deep_key];
                parentID = this.get('dirtyKeys').get(deep_key);
                if (parentID === void 0) {
                  parentID = this.get(deep_key);
                }
                if (parentID) {
                  url = "" + url + deep_plural + "/" + parentID + "/";
                } else {
  ...
  Batman.HashbangNavigator = (function(_super) {
    ...
    HashbangNavigator.prototype.handleLocation = function(location) {
      ...
      if (realPath === '/') {
        ...
        return location.replace(this.normalizePath("" + Batman.config.pathToApp + (this.linkTo(realPath))));
      }
    };
