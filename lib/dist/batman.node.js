...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.prototype._removeHandlers = function() {
      var changeEvent, handler, source, _i, _len, _ref;
      handler = this.sourceChangeHandler();
      if (this.sources) {
        _ref = this.sources;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
...
(function() {
  ...
  Batman.Observable = {
    ...
    property: function(key, createProperty) {
      var property, propertyClass, _base, _ref, _ref1;
      if (createProperty == null) {
        createProperty = true;
      }
      Batman.initializeObject(this);
      if (createProperty) {
        (_base = this._batman).properties || (_base.properties = new Batman.SimpleHash);
        property = this._batman.properties.get(key);
        propertyClass = this.propertyClass || Batman.Keypath;
        return property || ((_ref = this._batman.properties) != null ? _ref.set(key, new propertyClass(this, key)) : void 0);
      } else {
        return (_ref1 = this._batman.properties) != null ? _ref1.get(key) : void 0;
      }
    },
    get: function(key) {
...
(function() {
  ...
  Batman.DOM.ViewArgumentBinding = (function(_super) {
    ...
    function ViewArgumentBinding(definition, view) {
      this.view = view;
      ViewArgumentBinding.__super__.constructor.call(this, definition);
    }

    ViewArgumentBinding.prototype.die = function() {
      var argument, existingHandlers, handler, key, keyPath, keys, property, subkey, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      keys = this.view._batman.properties.keys();
      if (this.key) {
        _ref = this.view.get('argumentBindings')._batman.properties.toArray();
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          argument = _ref[_i];
          for (_j = 0, _len1 = keys.length; _j < _len1; _j++) {
            ...
            if (key.indexOf("" + argument) === 0) {
              ...
              keyPath = this.view.get("argumentBindings." + argument).key;
              existingHandlers = subkey.indexOf('.') === 0 ? (subkey = subkey.slice(1), (_ref1 = this.view.get(argument).property(subkey, false)) != null ? (_ref2 = _ref1.event('change', false)) != null ? _ref2.handlers : void 0 : void 0) : (_ref3 = this.view.property(key, false)) != null ? (_ref4 = _ref3.event('change', false)) != null ? _ref4.handlers : void 0 : void 0;
              if (existingHandlers) {
                if (subkey.length > 0) {
                  property = (_ref5 = this.get('keyContext')) != null ? (_ref6 = _ref5.get(keyPath)) != null ? _ref6.property(subkey, false) : void 0 : void 0;
                } else {
                  property = (_ref7 = this.get('keyContext')) != null ? _ref7.property(keyPath, false) : void 0;
                }
                if (!property) {
                  continue;
                }
                for (_k = 0, _len2 = existingHandlers.length; _k < _len2; _k++) {
                  handler = existingHandlers[_k];
  ...
  Batman.View = (function(_super) {
    ...
    View.accessor('argumentBindings', function() {
      ...
      return new Batman.TerminalAccessible(function(key) {
        ...
        return _this[bindingKey] = new Batman.DOM.ViewArgumentBinding(definition, _this);
      });
    });
