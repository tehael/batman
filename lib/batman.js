...
(function() {
  ...
  Batman.Property = (function() {
    ...
    function Property(base, key) {
      this.base = base;
      this.key = key;
      this.accessor = this.constructor.accessorForBaseAndKey(this.base, this.key);
      this.changeEvent = this.event('change');
    }
